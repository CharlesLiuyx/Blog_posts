...
<img src="【直观详解】线性代数中的正交正规正定转置/Matrix_transpose.gif" alt="" width="200">
...
![转置](【直观详解】线性代数中的正交正规正定转置/Transpose.jpg)

观察得到，和旋转有一定的关系的，但是其实这个几何意义已经十分抽象了，为了追根之底，从数学的角度进行一些更有意思的探究

#### 数学计算

为了发掘 $\mathbf A$ 和 $\mahtbf A^T$ 之间的关系，我们可以设有**转换矩阵** $\mathbf T$，其描述了从 $\mathbf A$ 到 $\mathbf A^T$ 的**变换**，写成公式为：
$$
